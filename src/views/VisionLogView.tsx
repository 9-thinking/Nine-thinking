...
export default function VisionLogView({
  onNavigate,
  user,
}: VisionLogViewProps) {
  ...
  const handleAddLog = async () => {
    ...
    const newLog = {
      ...
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuDHp4dcTZQaLpz7EVl7SmPCIh1Z5XlcWG30OxaYndrgeH1kO6koTtcwRTGu8pVAHqVh8X-vEBvG7imePrXeDRoxxk7QOHGd_y-bpetWqOvVCZjs12B-n-NswjfiO1LvhTUwgBRepkbryLDA2Z0YFUXpcznezBFUKKkJj3FB1kLPmp3J1IqfX1B5yxGu6-wz7XthnQ3yhzC6brgWzQuOZ8oY4PuEszK4hbgOnRPzeVjq7iu4osNihYb5zUlh9F63grqvQVRDAdnXdLw",
      tags: ["New", "Wellness"],
      sentiment: "Happy",
    };
  ...
  return (
    <div className="space-y-gutter pb-32 font-inter">
      ...
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-6 px-margin-mobile md:px-0">
        <div>
          ...
          <p className="text-on-surface-variant font-medium">
            Capture your journey, visual by visual.
          </p>
        </div>
      ...
      <section className="grid grid-cols-12 gap-gutter px-margin-mobile md:px-0">
        ...
        >
          <div className="flex-1 relative z-10">
            ...
            <h2 className="font-outfit font-black text-3xl mb-4 tracking-tight leading-tight">
              What are you <br />
              focusing on today?
            </h2>
            <button
        ...
        >
          <div>
            <h3 className="font-outfit font-black text-xl text-on-surface mb-2">
              Weekly Goal
            </h3>
            <p className="text-sm text-on-surface-variant mb-6">
              Complete 5 cardio sessions in KLCC park surroundings.
            </p>
          </div>

          <div className="space-y-4">
            <div className="flex justify-between items-end">
              <span className="text-3xl font-outfit font-black text-primary">
                3/5
              </span>
      ...
      <section className="grid grid-cols-12 gap-gutter px-margin-mobile md:px-0">
            ...
            <div className="p-6">
              ...
              <div className="flex flex-wrap gap-2">
                {log.tags.map((tag) => (
                  <span
                    key={tag}
                    className="px-3 py-1 bg-surface-container-low border border-outline-variant/30 rounded-full text-[10px] font-black uppercase tracking-widest text-on-surface-variant"
                  >
                    {tag}
                  </span>
                ))}
        ...
        <motion.div className="col-span-12 md:col-span-6 lg:col-span-4 bento-card flex flex-col items-center justify-center gap-6 border-dashed border-2 bg-transparent hover:bg-surface-container-low transition-all group">
          ...
          <div className="text-center px-8">
            <h3 className="font-outfit font-bold text-lg text-on-surface-variant mb-1">
              Add another moment
            </h3>
            <p className="text-xs text-on-surface-variant/50 leading-relaxed uppercase tracking-widest font-black">
              Build your vision log
            </p>
          </div>
